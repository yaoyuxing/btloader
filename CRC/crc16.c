...
unsigned short usCrc16 (unsigned char *pucMsg,unsigned short usDataLen )
{
	...
	unsigned char ucCRCLo = 0xFF ; /* CRC 的低字节初始化 */
	unsigned uIndex ; /* CRC 查询表索引 */
	while (usDataLen--) /* 完成整个报文缓冲区 */
	{
		uIndex = ucCRCLo ^ *pucMsg++ ; /* 计算 CRC */
		ucCRCLo = ucCRCHi^ sucCRCHi[uIndex] ;
